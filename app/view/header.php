...
<nav class="navbar navbar-default">
    <button class="btn btn-default" onclick="location.href='/'">홈</button>
    <?php
    if (!isset($_SESSION['username']) || $_SESSION['username'] == null)
    {
        echo "<button class='btn btn-default' id='signin-button'>로그인</button>";
        echo "<button class='btn btn-default' id='signup-button'>회원가입</button>";
    ...
    else
    {
        ...
        echo "<a href='/mypage'><button id='mypage-button' class='btn btn-default'>마이페이지</button></a>";
        echo "<button id='logout-button' class='btn btn-default'>로그아웃</button>";
